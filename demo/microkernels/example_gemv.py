...
@autotune(configs=get_thread_template_configs(), warmup=3, rep=20,)
@jit(out_idx=[-1], target="auto",)
...
def check_correctness_and_bench(msg, kernel, N, K, do_bench=True):
    ...
    if do_bench:
        ...
        print(f"{msg}: TileLang Latency: {latency} ms\n")
