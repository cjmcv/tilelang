...
extern "C" int create_linear_gemm_tl_1_151936_1024(bfloat16_t* __restrict__ A, bfloat16_t* __restrict__ B, bfloat16_t* __restrict__ C, CUtensorMap* out_A_desc, CUtensorMap* out_B_desc, CUtensorMap* out_C_desc, bool to_device) {
	...
	cuuint64_t B_desc_globalDim[2]= {1024,151936};
	...
	cuuint64_t C_desc_globalDim[2]= {151936,1};
	cuuint64_t C_desc_globalStride[2]= {2,303872};
	...
	//	linear_kernel<<<dim3(2374, 1, 1), dim3(384, 1, 1), 20480, stream>>>(A_desc, B_desc, C_desc);
