...
__device__ __forceinline__ void flashattn_kernel_1_8192_128_16_8_128__0(const int bx, const int by, const int bz,
  ...
  if ((((int)threadIdx.x) % 4) == 0) {
    ...
    for (int i_54 = 0; i_54 < 2; ++i_54) {
      if (((((((int)threadIdx.x) >> 5) * 8) + (i_54 * 4)) + ((((int)threadIdx.x) & 31) >> 3)) < 1) {
        glse[((((((((int)threadIdx.x) >> 5) * 128) + (i_54 * 64)) + (((int)by) * 16)) + (((((int)threadIdx.x) & 31) >> 2) * 8)) + ((int)bz))] = ((bfloat16_t)logsum[i_54]);
      }
    }
  }
  __syncthreads();
  ...
  for (int i_55 = 0; i_55 < 8; ++i_55) {
    tl::ptx_stmatrix_x4((&(((bfloat16_t*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 5) * 2048) + ((((int)threadIdx.x) & 15) * 128)) + (i_55 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), __pack_half2(((bfloat16_t)acc_o[(i_55 * 8)]), ((bfloat16_t)acc_o[((i_55 * 8) + 1)])), __pack_half2(((bfloat16_t)acc_o[((i_55 * 8) + 2)]), ((bfloat16_t)acc_o[((i_55 * 8) + 3)])), __pack_half2(((bfloat16_t)acc_o[((i_55 * 8) + 4)]), ((bfloat16_t)acc_o[((i_55 * 8) + 5)])), __pack_half2(((bfloat16_t)acc_o[((i_55 * 8) + 6)]), ((bfloat16_t)acc_o[((i_55 * 8) + 7)])));
  }
  __syncthreads();
...
// block_dim=(128, 1, 1).
// latency: 0 ms vs [ref-0 sim-0], idx: 13