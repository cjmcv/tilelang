...
__device__ __forceinline__ void flashattn_kernel_1_8192_2048_16_8_128__0(const int bx, const int by, const int bz,
  ...
  for (int i_39 = 0; i_39 < 8; ++i_39) {
    tl::ptx_stmatrix_x4((&(((bfloat16_t*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 5) * 2048) + ((((int)threadIdx.x) & 15) * 128)) + (i_39 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), __pack_half2(((bfloat16_t)acc_o[(i_39 * 8)]), ((bfloat16_t)acc_o[((i_39 * 8) + 1)])), __pack_half2(((bfloat16_t)acc_o[((i_39 * 8) + 2)]), ((bfloat16_t)acc_o[((i_39 * 8) + 3)])), __pack_half2(((bfloat16_t)acc_o[((i_39 * 8) + 4)]), ((bfloat16_t)acc_o[((i_39 * 8) + 5)])), __pack_half2(((bfloat16_t)acc_o[((i_39 * 8) + 6)]), ((bfloat16_t)acc_o[((i_39 * 8) + 7)])));
  }
  __syncthreads();
