...
__device__ __forceinline__ void flashattn_kernel_1_8192_64_16_8_128(const int bx, const int by, const int bz,
  ...
  if (0 < valid_kv_seqlen) {
    ...
    for (int i_5 = 0; i_5 < 2; ++i_5) {
      tl::cp_async_gs<16>(buf_dyn_shmem+(((((((((((int)threadIdx.x) & 15) >> 3) * 2048) + (i_5 * 1024)) + ((((int)threadIdx.x) >> 4) * 128)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 16)) + 28672), V+((((i_5 * 8192) + ((((int)threadIdx.x) >> 4) * 1024)) + (((int)by) * 128)) + ((((int)threadIdx.x) & 15) * 8)));
    }
    tl::cp_async_commit();
  }
  if (16 < valid_kv_seqlen) {
    ...
    for (int i_7 = 0; i_7 < 2; ++i_7) {
      tl::cp_async_gs<16>(buf_dyn_shmem+(((((((((((int)threadIdx.x) & 15) >> 3) * 2048) + (i_7 * 1024)) + ((((int)threadIdx.x) >> 4) * 128)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 16)) + 32768), V+(((((i_7 * 8192) + ((((int)threadIdx.x) >> 4) * 1024)) + (((int)by) * 128)) + ((((int)threadIdx.x) & 15) * 8)) + 16384));
    }
    tl::cp_async_commit();
  }
  if (32 < valid_kv_seqlen) {
    ...
    for (int i_8 = 0; i_8 < 2; ++i_8) {
      tl::cp_async_gs<16>(buf_dyn_shmem+(((((((((((int)threadIdx.x) & 15) >> 3) * 2048) + (i_8 * 1024)) + ((((int)threadIdx.x) >> 4) * 128)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 16)) + 24576), K+(((((i_8 * 8192) + ((((int)threadIdx.x) >> 4) * 1024)) + (((int)by) * 128)) + ((((int)threadIdx.x) & 15) * 8)) + 32768));
    }
    tl::cp_async_commit();
    #pragma unroll
    for (int i_9 = 0; i_9 < 2; ++i_9) {
      tl::cp_async_gs<16>(buf_dyn_shmem+(((((((((((int)threadIdx.x) & 15) >> 3) * 2048) + (i_9 * 1024)) + ((((int)threadIdx.x) >> 4) * 128)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 16)) + 36864), V+(((((i_9 * 8192) + ((((int)threadIdx.x) >> 4) * 1024)) + (((int)by) * 128)) + ((((int)threadIdx.x) & 15) * 8)) + 32768));
    }
    tl::cp_async_commit();
  }
  for (int k = 0; k < (((valid_kv_seqlen + 15) >> 4) - 3); ++k) {
    ...
    for (int i_11 = 0; i_11 < 2; ++i_11) {
      tl::cp_async_gs_conditional<16>(buf_dyn_shmem+(((((((((k % 3) * 4096) + (((((int)threadIdx.x) & 15) >> 3) * 2048)) + (i_11 * 1024)) + ((((int)threadIdx.x) >> 4) * 128)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 16)) + 16384), K+((((((((int64_t)k) * (int64_t)16384) + (((int64_t)i_11) * (int64_t)8192)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)4) * (int64_t)1024)) + (((int64_t)((int)by)) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)8)) + (int64_t)49152), (k < 509));
    }
    tl::cp_async_commit();
    #pragma unroll
    for (int i_12 = 0; i_12 < 8; ++i_12) {
      float condval_1;
      if ((((((k * 16) + ((i_12 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_12 & 1)) < valid_kv_seqlen)) {
        condval_1 = acc_s[i_12];
      } else {
        condval_1 = -CUDART_INF_F;
      }
      acc_s[i_12] = condval_1;
    }
    #pragma unroll
    for (int i_13 = 0; i_13 < 2; ++i_13) {
      scores_max_prev[i_13] = scores_max[i_13];
    }
    #pragma unroll
    ...
    for (int i_15 = 0; i_15 < 2; ++i_15) {
      ...
      for (int rv = 0; rv < 4; ++rv) {
        scores_max[i_15] = max(scores_max[i_15], acc_s[((((rv & 1) * 4) + (i_15 * 2)) + (rv >> 1))]);
      }
      scores_max[i_15] = tl::AllReduce<tl::MaxOp, 4, 1, 0>::run(scores_max[i_15]);
    }
    #pragma unroll
    ...
    for (int i_18 = 0; i_18 < 8; ++i_18) {
      acc_s[i_18] = exp2f(((acc_s[i_18] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/) - (scores_max[((i_18 & 3) >> 1)] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/)));
    }
    #pragma unroll
    for (int i_19 = 0; i_19 < 2; ++i_19) {
      ...
      for (int rv_1 = 0; rv_1 < 4; ++rv_1) {
        scores_sum[i_19] = (scores_sum[i_19] + acc_s[((((rv_1 & 1) * 4) + (i_19 * 2)) + (rv_1 >> 1))]);
      }
    ...
    for (int i_23 = 0; i_23 < 8; ++i_23) {
      tl::ptx_ldmatrix_x4_trans((&(((bfloat16_t*)buf_dyn_shmem)[((((((k % 3) * 2048) + ((i_23 >> 2) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_23 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_23 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) + 14336)])) + 0, B_local_1 + (i_23 * 8));
    }
    for (int j = 0; j < 8; ++j) {
    ...
    for (int i_24 = 0; i_24 < 2; ++i_24) {
      tl::cp_async_gs_conditional<16>(buf_dyn_shmem+(((((((((k % 3) * 4096) + (((((int)threadIdx.x) & 15) >> 3) * 2048)) + (i_24 * 1024)) + ((((int)threadIdx.x) >> 4) * 128)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 16)) + 28672), V+((((((((int64_t)k) * (int64_t)16384) + (((int64_t)i_24) * (int64_t)8192)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)4) * (int64_t)1024)) + (((int64_t)((int)by)) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)8)) + (int64_t)49152), (k < 509));
    }
    tl::cp_async_commit();
  }
  if (33 <= valid_kv_seqlen) {
    ...
    for (int i_25 = 0; i_25 < 4; ++i_25) {
      *(float2*)(acc_s + (i_25 * 2)) = make_float2(0x0p+0f/*0.000000e+00*/, 0x0p+0f/*0.000000e+00*/);
    }
    tl::cp_async_wait<2>();
    __syncthreads();
    ...
    for (int i_26 = 0; i_26 < 8; ++i_26) {
      float condval_2;
      if ((((((((valid_kv_seqlen + 15) >> 4) * 16) + ((i_26 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_26 & 1)) < (valid_kv_seqlen + 48))) {
    ...
    for (int i_29 = 0; i_29 < 2; ++i_29) {
      ...
      for (int rv_2 = 0; rv_2 < 4; ++rv_2) {
        scores_max[i_29] = max(scores_max[i_29], acc_s[((((rv_2 & 1) * 4) + (i_29 * 2)) + (rv_2 >> 1))]);
      }
    ...
    for (int i_33 = 0; i_33 < 2; ++i_33) {
      ...
      for (int rv_3 = 0; rv_3 < 4; ++rv_3) {
        scores_sum[i_33] = (scores_sum[i_33] + acc_s[((((rv_3 & 1) * 4) + (i_33 * 2)) + (rv_3 >> 1))]);
      }
    ...
    for (int i_37 = 0; i_37 < 8; ++i_37) {
      tl::ptx_ldmatrix_x4_trans((&(((bfloat16_t*)buf_dyn_shmem)[((((((((valid_kv_seqlen + 15) % 48) >> 4) * 2048) + ((i_37 >> 2) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_37 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_37 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) + 14336)])) + 0, B_local_1 + (i_37 * 8));
    }
  ...
  if (17 <= valid_kv_seqlen) {
    ...
    for (int i_39 = 0; i_39 < 8; ++i_39) {
      float condval_3;
      if ((((((((valid_kv_seqlen + 15) >> 4) * 16) + ((i_39 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_39 & 1)) < (valid_kv_seqlen + 32))) {
        condval_3 = acc_s[i_39];
      } else {
        condval_3 = -CUDART_INF_F;
      }
      acc_s[i_39] = condval_3;
    }
    #pragma unroll
    ...
    for (int i_42 = 0; i_42 < 2; ++i_42) {
      ...
      for (int rv_4 = 0; rv_4 < 4; ++rv_4) {
        scores_max[i_42] = max(scores_max[i_42], acc_s[((((rv_4 & 1) * 4) + (i_42 * 2)) + (rv_4 >> 1))]);
      }
    ...
    for (int i_45 = 0; i_45 < 8; ++i_45) {
      acc_s[i_45] = exp2f(((acc_s[i_45] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/) - (scores_max[((i_45 & 3) >> 1)] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/)));
    }
    #pragma unroll
    for (int i_46 = 0; i_46 < 2; ++i_46) {
      ...
      for (int rv_5 = 0; rv_5 < 4; ++rv_5) {
        scores_sum[i_46] = (scores_sum[i_46] + acc_s[((((rv_5 & 1) * 4) + (i_46 * 2)) + (rv_5 >> 1))]);
      }
      scores_sum[i_46] = tl::AllReduce<tl::SumOp, 4, 1, 0>::run(scores_sum[i_46]);
    }
    #pragma unroll
    for (int i_47 = 0; i_47 < 2; ++i_47) {
      logsum[i_47] = ((logsum[i_47] * scores_scale[i_47]) + scores_sum[i_47]);
    }
    #pragma unroll
    for (int i_48 = 0; i_48 < 4; ++i_48) {
      uint1 __3;
      float2 v__2 = *(float2*)(acc_s + (i_48 * 2));
      *reinterpret_cast<__nv_bfloat162*>(&(__3)) = __float22bfloat162_rn(*(float2*)(&(v__2)));
      *(uint1*)(acc_s_cast + (i_48 * 2)) = __3;
    }
    #pragma unroll
    for (int i_49 = 0; i_49 < 64; ++i_49) {
      acc_o[i_49] = (acc_o[i_49] * scores_scale[((i_49 & 3) >> 1)]);
    }
    tl::cp_async_wait<1>();
    __syncthreads();
    for (int i_50 = 0; i_50 < 8; ++i_50) {
      tl::ptx_ldmatrix_x4_trans((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((valid_kv_seqlen + 15) >> 4) + 1) % 3) * 2048) + ((i_50 >> 2) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_50 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_50 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) + 14336)])) + 0, B_local_1 + (i_50 * 8));
    }
  ...
  if (1 <= valid_kv_seqlen) {
    ...
    for (int i_51 = 0; i_51 < 4; ++i_51) {
      *(float2*)(acc_s + (i_51 * 2)) = make_float2(0x0p+0f/*0.000000e+00*/, 0x0p+0f/*0.000000e+00*/);
    }
    tl::cp_async_wait<0>();
    __syncthreads();
    ...
    for (int i_52 = 0; i_52 < 8; ++i_52) {
      float condval_4;
      if ((((((((valid_kv_seqlen + 15) >> 4) * 16) + ((i_52 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_52 & 1)) < (valid_kv_seqlen + 16))) {
        condval_4 = acc_s[i_52];
      } else {
        condval_4 = -CUDART_INF_F;
      }
      acc_s[i_52] = condval_4;
    }
    #pragma unroll
    for (int i_53 = 0; i_53 < 2; ++i_53) {
      scores_max_prev[i_53] = scores_max[i_53];
    }
    #pragma unroll
    for (int i_54 = 0; i_54 < 2; ++i_54) {
      scores_max[i_54] = -CUDART_INF_F;
    }
    #pragma unroll
    for (int i_55 = 0; i_55 < 2; ++i_55) {
      #pragma unroll
      for (int rv_6 = 0; rv_6 < 4; ++rv_6) {
        scores_max[i_55] = max(scores_max[i_55], acc_s[((((rv_6 & 1) * 4) + (i_55 * 2)) + (rv_6 >> 1))]);
      }
      scores_max[i_55] = tl::AllReduce<tl::MaxOp, 4, 1, 0>::run(scores_max[i_55]);
    }
    #pragma unroll
    ...
    for (int i_57 = 0; i_57 < 2; ++i_57) {
      scores_scale[i_57] = exp2f(((scores_max_prev[i_57] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/) - (scores_max[i_57] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/)));
    }
    #pragma unroll
    ...
    for (int i_59 = 0; i_59 < 2; ++i_59) {
      ...
      for (int rv_7 = 0; rv_7 < 4; ++rv_7) {
        scores_sum[i_59] = (scores_sum[i_59] + acc_s[((((rv_7 & 1) * 4) + (i_59 * 2)) + (rv_7 >> 1))]);
      }
      scores_sum[i_59] = tl::AllReduce<tl::SumOp, 4, 1, 0>::run(scores_sum[i_59]);
    }
    #pragma unroll
    for (int i_60 = 0; i_60 < 2; ++i_60) {
      logsum[i_60] = ((logsum[i_60] * scores_scale[i_60]) + scores_sum[i_60]);
    }
    #pragma unroll
    for (int i_61 = 0; i_61 < 4; ++i_61) {
      uint1 __4;
      float2 v__3 = *(float2*)(acc_s + (i_61 * 2));
      *reinterpret_cast<__nv_bfloat162*>(&(__4)) = __float22bfloat162_rn(*(float2*)(&(v__3)));
      *(uint1*)(acc_s_cast + (i_61 * 2)) = __4;
    }
    #pragma unroll
    for (int i_62 = 0; i_62 < 64; ++i_62) {
      acc_o[i_62] = (acc_o[i_62] * scores_scale[((i_62 & 3) >> 1)]);
    }
    tl::cp_async_wait<0>();
    __syncthreads();
    for (int i_63 = 0; i_63 < 8; ++i_63) {
      tl::ptx_ldmatrix_x4_trans((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((valid_kv_seqlen + 15) >> 4) + 2) % 3) * 2048) + ((i_63 >> 2) * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_63 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_63 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) + 14336)])) + 0, B_local_1 + (i_63 * 8));
    }
  ...
  for (int i_65 = 0; i_65 < 2; ++i_65) {
    logsum[i_65] = (log2f(logsum[i_65]) + (scores_max[i_65] * 0x1.0527dbd5cafffp-3f/*1.275174e-01*/));
  }
  __syncthreads();
  #pragma unroll
  for (int i_66 = 0; i_66 < 8; ++i_66) {
    tl::ptx_stmatrix_x4((&(((bfloat16_t*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 5) * 2048) + ((((int)threadIdx.x) & 15) * 128)) + (i_66 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), __pack_half2(((bfloat16_t)acc_o[(i_66 * 8)]), ((bfloat16_t)acc_o[((i_66 * 8) + 1)])), __pack_half2(((bfloat16_t)acc_o[((i_66 * 8) + 2)]), ((bfloat16_t)acc_o[((i_66 * 8) + 3)])), __pack_half2(((bfloat16_t)acc_o[((i_66 * 8) + 4)]), ((bfloat16_t)acc_o[((i_66 * 8) + 5)])), __pack_half2(((bfloat16_t)acc_o[((i_66 * 8) + 6)]), ((bfloat16_t)acc_o[((i_66 * 8) + 7)])));
  }
  __syncthreads();
...
// block_dim=(128, 1, 1).
// latency: 0 ms vs [ref-0 sim-0], idx: 2