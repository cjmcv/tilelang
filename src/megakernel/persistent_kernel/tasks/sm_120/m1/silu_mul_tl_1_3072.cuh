...
__device__ __forceinline__ void silu_mul_kernel_1_3072(const int bx, const int by, const int bz,
  ...
  uint2 condval;
  if (((((int)threadIdx.x) < 16) && (((int)threadIdx.x) < 16))) {
    condval = *(uint2*)(A + ((((int)bx) * 64) + (((int)threadIdx.x) * 4)));
  } else {
  ...
  *(uint2*)(((bfloat16_t*)buf_dyn_shmem) + (((int)threadIdx.x) * 4)) = condval;
  uint2 condval_1;
  if (((((int)threadIdx.x) < 16) && (((int)threadIdx.x) < 16))) {
    condval_1 = *(uint2*)(A + (((((int)bx) * 64) + (((int)threadIdx.x) * 4)) + 3072));
  } else {
  ...
  *(uint2*)(((bfloat16_t*)buf_dyn_shmem) + ((((int)threadIdx.x) * 4) + 1024)) = condval_1;
  float4 __1;
  ...
  float4 __7;
    float4 __8;
      ...
      __8.w = (xi.w*sig.w);
    float4 __9;
    uint2 v__3 = *(uint2*)(((bfloat16_t*)buf_dyn_shmem) + ((((int)threadIdx.x) * 4) + 1024));
  ...
  *(uint2*)(((bfloat16_t*)buf_dyn_shmem) + ((((int)threadIdx.x) * 4) + 2048)) = __6;
  __syncthreads();
  if (((int)threadIdx.x) < 16) {
    *(uint2*)(C + ((((int)bx) * 64) + (((int)threadIdx.x) * 4))) = *(uint2*)(((bfloat16_t*)buf_dyn_shmem) + ((((int)threadIdx.x) * 4) + 2048));
  }
}
...
// selected_hparams: [16, 64, 256].
// smem: 6144 bytes.
// use_cooperative_groups: 0.
// layout: (48, 1, 1), (64, 16, 1)
// block_dim=(256, 1, 1).
// latency: 0.00465 ms vs [ref-0 sim-0], idx: 0