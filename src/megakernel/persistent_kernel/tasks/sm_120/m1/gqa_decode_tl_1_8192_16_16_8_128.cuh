...
__device__ __forceinline__ void flashattn_kernel_1_8192_16_16_8_128(const int bx, const int by, const int bz,
  ...
  if (0 < valid_kv_seqlen) {
    ...
    for (int i_5 = 0; i_5 < 4; ++i_5) {
      tl::cp_async_gs<16>(buf_dyn_shmem+(((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i_5 * 1024)) + ((((int)threadIdx.x) >> 4) * 128)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 16)) + 40960), V+((((i_5 * 8192) + ((((int)threadIdx.x) >> 4) * 1024)) + (((int)by) * 128)) + ((((int)threadIdx.x) & 15) * 8)));
    }
    tl::cp_async_commit();
  }
  if (32 < valid_kv_seqlen) {
    ...
    for (int i_7 = 0; i_7 < 4; ++i_7) {
      tl::cp_async_gs<16>(buf_dyn_shmem+(((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i_7 * 1024)) + ((((int)threadIdx.x) >> 4) * 128)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 16)) + 49152), V+(((((i_7 * 8192) + ((((int)threadIdx.x) >> 4) * 1024)) + (((int)by) * 128)) + ((((int)threadIdx.x) & 15) * 8)) + 32768));
    }
    tl::cp_async_commit();
  }
  if (64 < valid_kv_seqlen) {
    ...
    for (int i_8 = 0; i_8 < 4; ++i_8) {
      tl::cp_async_gs<16>(buf_dyn_shmem+(((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i_8 * 1024)) + ((((int)threadIdx.x) >> 4) * 128)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 16)) + 32768), K+(((((i_8 * 8192) + ((((int)threadIdx.x) >> 4) * 1024)) + (((int)by) * 128)) + ((((int)threadIdx.x) & 15) * 8)) + 65536));
    }
    tl::cp_async_commit();
    #pragma unroll
    for (int i_9 = 0; i_9 < 4; ++i_9) {
      tl::cp_async_gs<16>(buf_dyn_shmem+(((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i_9 * 1024)) + ((((int)threadIdx.x) >> 4) * 128)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 16)) + 57344), V+(((((i_9 * 8192) + ((((int)threadIdx.x) >> 4) * 1024)) + (((int)by) * 128)) + ((((int)threadIdx.x) & 15) * 8)) + 65536));
    }
    tl::cp_async_commit();
  }
  for (int k = 0; k < (((valid_kv_seqlen + 31) >> 5) - 3); ++k) {
    ...
    for (int i_13 = 0; i_13 < 16; ++i_13) {
      float condval_1;
      if ((((((k * 32) + ((i_13 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_13 & 1)) < valid_kv_seqlen)) {
        condval_1 = acc_s[i_13];
      } else {
        condval_1 = -CUDART_INF_F;
      }
      acc_s[i_13] = condval_1;
    }
    #pragma unroll
  ...
  if (65 <= valid_kv_seqlen) {
    ...
    for (int ki_2 = 0; ki_2 < 8; ++ki_2) {
      ...
      for (int i_27 = 0; i_27 < 2; ++i_27) {
        tl::ptx_ldmatrix_x4((&(((bfloat16_t*)buf_dyn_shmem)[((((((((((((valid_kv_seqlen + 31) % 96) >> 5) * 4096) + ((ki_2 >> 2) * 2048)) + (i_27 * 1024)) + (((((int)threadIdx.x) & 31) >> 4) * 512)) + ((((int)threadIdx.x) & 7) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + ((ki_2 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_2 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)])) + 0, B_local + (i_27 * 8));
      }
    ...
    for (int i_28 = 0; i_28 < 16; ++i_28) {
      float condval_2;
      if ((((((((valid_kv_seqlen + 31) >> 5) * 32) + ((i_28 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_28 & 1)) < (valid_kv_seqlen + 96))) {
        condval_2 = acc_s[i_28];
      } else {
        condval_2 = -CUDART_INF_F;
      }
      acc_s[i_28] = condval_2;
    }
    #pragma unroll
    ...
    for (int ki_3 = 0; ki_3 < 2; ++ki_3) {
      for (int i_39 = 0; i_39 < 8; ++i_39) {
        tl::ptx_ldmatrix_x4_trans((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((valid_kv_seqlen + 31) % 96) >> 5) * 4096) + ((i_39 >> 2) * 2048)) + (ki_3 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_39 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_39 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) + 20480)])) + 0, B_local_1 + (i_39 * 8));
      }
  ...
  if (33 <= valid_kv_seqlen) {
    ...
    for (int ki_4 = 0; ki_4 < 8; ++ki_4) {
      ...
      for (int i_41 = 0; i_41 < 2; ++i_41) {
        tl::ptx_ldmatrix_x4((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((((((valid_kv_seqlen + 31) >> 5) + 1) % 3) * 4096) + ((ki_4 >> 2) * 2048)) + (i_41 * 1024)) + (((((int)threadIdx.x) & 31) >> 4) * 512)) + ((((int)threadIdx.x) & 7) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + ((ki_4 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_4 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)])) + 0, B_local + (i_41 * 8));
      }
    ...
    for (int i_42 = 0; i_42 < 16; ++i_42) {
      float condval_3;
      if ((((((((valid_kv_seqlen + 31) >> 5) * 32) + ((i_42 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_42 & 1)) < (valid_kv_seqlen + 64))) {
        condval_3 = acc_s[i_42];
      } else {
        condval_3 = -CUDART_INF_F;
      }
      acc_s[i_42] = condval_3;
    }
    #pragma unroll
    ...
    for (int ki_5 = 0; ki_5 < 2; ++ki_5) {
      for (int i_53 = 0; i_53 < 8; ++i_53) {
        tl::ptx_ldmatrix_x4_trans((&(((bfloat16_t*)buf_dyn_shmem)[((((((((((valid_kv_seqlen + 31) >> 5) + 1) % 3) * 4096) + ((i_53 >> 2) * 2048)) + (ki_5 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_53 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_53 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) + 20480)])) + 0, B_local_1 + (i_53 * 8));
      }
  ...
  if (1 <= valid_kv_seqlen) {
    ...
    for (int ki_6 = 0; ki_6 < 8; ++ki_6) {
      ...
      for (int i_55 = 0; i_55 < 2; ++i_55) {
        tl::ptx_ldmatrix_x4((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((((((valid_kv_seqlen + 31) >> 5) + 2) % 3) * 4096) + ((ki_6 >> 2) * 2048)) + (i_55 * 1024)) + (((((int)threadIdx.x) & 31) >> 4) * 512)) + ((((int)threadIdx.x) & 7) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + ((ki_6 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_6 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)])) + 0, B_local + (i_55 * 8));
      }
    ...
    for (int i_56 = 0; i_56 < 16; ++i_56) {
      float condval_4;
      if ((((((((valid_kv_seqlen + 31) >> 5) * 32) + ((i_56 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_56 & 1)) < (valid_kv_seqlen + 32))) {
        condval_4 = acc_s[i_56];
      } else {
        condval_4 = -CUDART_INF_F;
      }
      acc_s[i_56] = condval_4;
    }
    #pragma unroll
    ...
    for (int ki_7 = 0; ki_7 < 2; ++ki_7) {
      for (int i_67 = 0; i_67 < 8; ++i_67) {
        tl::ptx_ldmatrix_x4_trans((&(((bfloat16_t*)buf_dyn_shmem)[((((((((((valid_kv_seqlen + 31) >> 5) + 2) % 3) * 4096) + ((i_67 >> 2) * 2048)) + (ki_7 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_67 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_67 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) + 20480)])) + 0, B_local_1 + (i_67 * 8));
      }
  ...
  for (int i_70 = 0; i_70 < 8; ++i_70) {
    tl::ptx_stmatrix_x4((&(((bfloat16_t*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 5) * 2048) + ((((int)threadIdx.x) & 15) * 128)) + (i_70 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8))])), __pack_half2(((bfloat16_t)acc_o[(i_70 * 8)]), ((bfloat16_t)acc_o[((i_70 * 8) + 1)])), __pack_half2(((bfloat16_t)acc_o[((i_70 * 8) + 2)]), ((bfloat16_t)acc_o[((i_70 * 8) + 3)])), __pack_half2(((bfloat16_t)acc_o[((i_70 * 8) + 4)]), ((bfloat16_t)acc_o[((i_70 * 8) + 5)])), __pack_half2(((bfloat16_t)acc_o[((i_70 * 8) + 6)]), ((bfloat16_t)acc_o[((i_70 * 8) + 7)])));
  }
  __syncthreads();
...
// block_dim=(128, 1, 1).
// latency: 0 ms vs [ref-0 sim-0], idx: 5