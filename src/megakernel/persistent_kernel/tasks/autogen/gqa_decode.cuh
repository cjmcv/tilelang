    ...
    if constexpr (HEAD == 16) {
      if constexpr (SUB_KERNEL_ID == 0) {
        if (step > 0 && step <= 16) {
          ...
          flashattn_kernel_1_8192_32_16_8_128<T, THREAD_NUM, SUB_KERNEL_ID, M, HEAD, GROUPS, DIM>(bx, by, bz, q, k, v, edge_ptr, mask_ptr, output_ptr, glse_ptr, output_partial_ptr);
        }
        else if (step > 32 && step <= 64) {
          flashattn_kernel_1_8192_64_16_8_128<T, THREAD_NUM, SUB_KERNEL_ID, M, HEAD, GROUPS, DIM>(bx, by, bz, q, k, v, edge_ptr, mask_ptr, output_ptr, glse_ptr, output_partial_ptr);
        }
        else if (step > 64 && step <= 128) {
          flashattn_kernel_1_8192_128_16_8_128__0<T, THREAD_NUM, SUB_KERNEL_ID, M, HEAD, GROUPS, DIM>(bx, by, bz, q, k, v, edge_ptr, mask_ptr, output_ptr, glse_ptr, output_partial_ptr);
        }
        else if (step > 128 && step <= 256) {
          flashattn_kernel_1_8192_256_16_8_128__0<T, THREAD_NUM, SUB_KERNEL_ID, M, HEAD, GROUPS, DIM>(bx, by, bz, q, k, v, edge_ptr, mask_ptr, output_ptr, glse_ptr, output_partial_ptr);
        }
        else if (step > 256 && step <= 512) {
          flashattn_kernel_1_8192_512_16_8_128__0<T, THREAD_NUM, SUB_KERNEL_ID, M, HEAD, GROUPS, DIM>(bx, by, bz, q, k, v, edge_ptr, mask_ptr, output_ptr, glse_ptr, output_partial_ptr);
        }
        else if (step > 512 && step <= 1024) {
          flashattn_kernel_1_8192_1024_16_8_128__0<T, THREAD_NUM, SUB_KERNEL_ID, M, HEAD, GROUPS, DIM>(bx, by, bz, q, k, v, edge_ptr, mask_ptr, output_ptr, glse_ptr, output_partial_ptr);
        }
