...
template <typename T,
          ...
          int GROUPS,
          int DIM>
__device__ __forceinline__ void flashattn_kernel_1_8192_14_16_8_128(const int bx, const int by, const int bz,
  ...
  for (int i_6 = 0; i_6 < 8; ++i_6) {
    float condval_1;
    if (((((i_6 >> 2) * 4) + (((int)threadIdx.x) & 3)) < 7)) {
      condval_1 = acc_s[i_6];
    } else {
...
// Strategy: gqa_decode_tl_1_8192_14_16_8_128
// selected_hparams: [16, 64, 1, 1, 128].
// smem: 20480 bytes.
// use_cooperative_groups: 0.
// layout: (1, 8, 1), (16, 64, 1)
// block_dim=(128, 1, 1).
// latency: 0.00889 ms vs [ref-0.00917 sim-1.0], idx: -1