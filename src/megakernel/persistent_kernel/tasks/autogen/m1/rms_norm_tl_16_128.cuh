...
template <typename T,
        ...
        int M,
        int N>
__device__ __forceinline__ void rms_norm_kernel_16_128(const int bx, const int by, const int bz,
  ...
  static_assert(M==16); static_assert(N==128);
...
// Strategy: rms_norm_tl_16_128
// selected_hparams: [1, 1, 128].
// smem: 512 bytes.
// use_cooperative_groups: 0.
// layout: (16, 1, 1), (1, 1, 1)
// block_dim=(128, 1, 1).
// latency: 0.00344 ms vs [ref-0.00503 sim-0.99999], idx: 0