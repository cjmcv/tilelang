...
__device__ __forceinline__ void flashattn_kernel_1_8192_128_16_8_128__0(const int bx, const int by, const int bz,
  ...
  if constexpr (SUB_KERNEL_ID == 0) { if (bx >= 1 || by >= 8 || bz >= 4) { return; } }
  ...
  if (0 < condval_1) {
    ...
    for (int i_4 = 0; i_4 < 4; ++i_4) {
      tl::cp_async_gs_conditional<16>(buf_dyn_shmem+(((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i_4 * 1024)) + ((((int)threadIdx.x) >> 4) * 128)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 16)) + 16384), K+(((((((int64_t)i_4) * (int64_t)8192) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)4) * (int64_t)1024)) + ((((int64_t)((int)bz)) * (((int64_t)actual_kv_seqlen) >> (int64_t)2)) * (int64_t)1024)) + (((int64_t)((int)by)) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)8)), ((((((((((int)threadIdx.x) >> 4) + (((int)bz) * (actual_kv_seqlen >> 2))) >> 3) + i_4) < 1024) && (0 <= (((i_4 * 8) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 2))))) && (0 <= (((i_4 * 8) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 2))))) && (((((((int)threadIdx.x) >> 4) + (((int)bz) * (actual_kv_seqlen >> 2))) >> 3) + i_4) < 1024)));
    }
    tl::cp_async_commit();
    #pragma unroll
    for (int i_5 = 0; i_5 < 4; ++i_5) {
      tl::cp_async_gs_conditional<16>(buf_dyn_shmem+(((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i_5 * 1024)) + ((((int)threadIdx.x) >> 4) * 128)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 16)) + 24576), V+(((((((int64_t)i_5) * (int64_t)8192) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)4) * (int64_t)1024)) + ((((int64_t)((int)bz)) * (((int64_t)actual_kv_seqlen) >> (int64_t)2)) * (int64_t)1024)) + (((int64_t)((int)by)) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)8)), ((((((((((int)threadIdx.x) >> 4) + (((int)bz) * (actual_kv_seqlen >> 2))) >> 3) + i_5) < 1024) && (0 <= (((i_5 * 8) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 2))))) && (0 <= (((i_5 * 8) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 2))))) && (((((((int)threadIdx.x) >> 4) + (((int)bz) * (actual_kv_seqlen >> 2))) >> 3) + i_5) < 1024)));
    }
    tl::cp_async_commit();
  }
  int condval_2;
  ...
  for (int k = 0; k < (((condval_2 + 31) >> 5) - 1); ++k) {
    ...
    for (int ki = 0; ki < 8; ++ki) {
      ...
      for (int i_7 = 0; i_7 < 2; ++i_7) {
        tl::ptx_ldmatrix_x4((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((ki >> 2) * 2048) + (i_7 * 1024)) + (((((int)threadIdx.x) & 31) >> 4) * 512)) + ((((int)threadIdx.x) & 7) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + ((ki & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)])) + 0, B_local + (i_7 * 8));
      }
      for (int j = 0; j < 2; ++j) {
    ...
    for (int i_8 = 0; i_8 < 4; ++i_8) {
      tl::cp_async_gs_conditional<16>(buf_dyn_shmem+(((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i_8 * 1024)) + ((((int)threadIdx.x) >> 4) * 128)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 16)) + 16384), K+(((((((((int64_t)k) * (int64_t)32768) + (((int64_t)i_8) * (int64_t)8192)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)4) * (int64_t)1024)) + ((((int64_t)((int)bz)) * (((int64_t)actual_kv_seqlen) >> (int64_t)2)) * (int64_t)1024)) + (((int64_t)((int)by)) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)8)) + (int64_t)32768), ((((((((k * 32) + (i_8 * 8)) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 2))) < 8160) && (-32 <= ((((k * 32) + (i_8 * 8)) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 2))))) && (-32 <= ((((k * 32) + (i_8 * 8)) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 2))))) && (((((k * 32) + (i_8 * 8)) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 2))) < 8160)));
    }
    tl::cp_async_commit();
    #pragma unroll
    for (int i_9 = 0; i_9 < 16; ++i_9) {
      ...
      float condval_3;
      if ((((((k * 32) + ((i_9 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_9 & 1)) < condval_4)) {
        condval_3 = acc_s[i_9];
      } else {
    ...
    for (int i_12 = 0; i_12 < 2; ++i_12) {
      ...
      for (int rv = 0; rv < 8; ++rv) {
        scores_max[i_12] = max(scores_max[i_12], acc_s[((((rv & 3) * 4) + (i_12 * 2)) + (rv >> 2))]);
      }
    ...
    for (int ki_1 = 0; ki_1 < 2; ++ki_1) {
      for (int i_20 = 0; i_20 < 8; ++i_20) {
        tl::ptx_ldmatrix_x4_trans((&(((bfloat16_t*)buf_dyn_shmem)[((((((i_20 >> 2) * 2048) + (ki_1 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_20 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_20 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) + 12288)])) + 0, B_local_1 + (i_20 * 8));
      }
    ...
    for (int i_21 = 0; i_21 < 4; ++i_21) {
      tl::cp_async_gs_conditional<16>(buf_dyn_shmem+(((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i_21 * 1024)) + ((((int)threadIdx.x) >> 4) * 128)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 16)) + 24576), V+(((((((((int64_t)k) * (int64_t)32768) + (((int64_t)i_21) * (int64_t)8192)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)4) * (int64_t)1024)) + ((((int64_t)((int)bz)) * (((int64_t)actual_kv_seqlen) >> (int64_t)2)) * (int64_t)1024)) + (((int64_t)((int)by)) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)8)) + (int64_t)32768), ((((((((k * 32) + (i_21 * 8)) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 2))) < 8160) && (-32 <= ((((k * 32) + (i_21 * 8)) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 2))))) && (-32 <= ((((k * 32) + (i_21 * 8)) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 2))))) && (((((k * 32) + (i_21 * 8)) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 2))) < 8160)));
    }
    tl::cp_async_commit();
  }
  int condval_5;
  ...
  if (1 <= condval_5) {
    ...
    for (int ki_2 = 0; ki_2 < 8; ++ki_2) {
      ...
      for (int i_23 = 0; i_23 < 2; ++i_23) {
        tl::ptx_ldmatrix_x4((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((ki_2 >> 2) * 2048) + (i_23 * 1024)) + (((((int)threadIdx.x) & 31) >> 4) * 512)) + ((((int)threadIdx.x) & 7) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + ((ki_2 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_2 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)])) + 0, B_local + (i_23 * 8));
      }
    ...
    for (int i_24 = 0; i_24 < 16; ++i_24) {
      ...
      float condval_6;
      if ((((((((condval_7 + 31) >> 5) * 32) + ((i_24 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_24 & 1)) < (condval_8 + 32))) {
    ...
    for (int i_27 = 0; i_27 < 2; ++i_27) {
      ...
      for (int rv_2 = 0; rv_2 < 8; ++rv_2) {
        scores_max[i_27] = max(scores_max[i_27], acc_s[((((rv_2 & 3) * 4) + (i_27 * 2)) + (rv_2 >> 2))]);
      }
    ...
    for (int i_31 = 0; i_31 < 2; ++i_31) {
      ...
      for (int rv_3 = 0; rv_3 < 8; ++rv_3) {
        scores_sum[i_31] = (scores_sum[i_31] + acc_s[((((rv_3 & 3) * 4) + (i_31 * 2)) + (rv_3 >> 2))]);
      }
  ...
  if ((((int)threadIdx.x) % 4) == 0) {
    ...
    for (int i_38 = 0; i_38 < 2; ++i_38) {
      if (((((((int)threadIdx.x) >> 5) * 8) + (i_38 * 4)) + ((((int)threadIdx.x) & 31) >> 3)) < 1) {
        glse[((((((((int)threadIdx.x) >> 5) * 64) + (i_38 * 32)) + (((int)by) * 8)) + (((((int)threadIdx.x) & 31) >> 2) * 4)) + ((int)bz))] = ((bfloat16_t)logsum[i_38]);
      }
    }
  }
  __syncthreads();
...
// block_dim=(128, 1, 1).
// latency: 0.01491 ms vs [ref-0.01451 sim-0.99998], idx: 9