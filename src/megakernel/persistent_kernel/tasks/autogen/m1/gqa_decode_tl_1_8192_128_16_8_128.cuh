...
__device__ __forceinline__ void flashattn_kernel_1_8192_128_16_8_128__0(const int bx, const int by, const int bz,
  ...
  if (0 < condval_1) {
    ...
    for (int i_5 = 0; i_5 < 4; ++i_5) {
      tl::cp_async_gs_conditional<16>(buf_dyn_shmem+(((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i_5 * 1024)) + ((((int)threadIdx.x) >> 4) * 128)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 16)) + 32768), V+(((((((int64_t)i_5) * (int64_t)8192) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)4) * (int64_t)1024)) + ((((int64_t)((int)bz)) * (((int64_t)actual_kv_seqlen) >> (int64_t)1)) * (int64_t)1024)) + (((int64_t)((int)by)) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)8)), (((((((i_5 * 8) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 1))) < 8192) && (0 <= (((i_5 * 8) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 1))))) && (0 <= (((i_5 * 8) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 1))))) && ((((i_5 * 8) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 1))) < 8192)));
    }
    tl::cp_async_commit();
  }
  int condval_2;
  ...
  for (int k = 0; k < (((condval_3 + 31) >> 5) - 2); ++k) {
    ...
    for (int i_11 = 0; i_11 < 16; ++i_11) {
      ...
      float condval_4;
      if ((((((k * 32) + ((i_11 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_11 & 1)) < condval_5)) {
  ...
  if (33 <= condval_6) {
    ...
    for (int ki_2 = 0; ki_2 < 8; ++ki_2) {
      ...
      for (int i_25 = 0; i_25 < 2; ++i_25) {
        ...
        tl::ptx_ldmatrix_x4((&(((bfloat16_t*)buf_dyn_shmem)[((((((((((((condval_7 + 31) & 63) >> 5) * 4096) + ((ki_2 >> 2) * 2048)) + (i_25 * 1024)) + (((((int)threadIdx.x) & 31) >> 4) * 512)) + ((((int)threadIdx.x) & 7) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + ((ki_2 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_2 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)])) + 0, B_local + (i_25 * 8));
      }
    ...
    for (int i_26 = 0; i_26 < 16; ++i_26) {
      ...
      float condval_8;
      if ((((((((condval_9 + 31) >> 5) * 32) + ((i_26 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_26 & 1)) < (condval_10 + 64))) {
    ...
    for (int ki_3 = 0; ki_3 < 2; ++ki_3) {
      for (int i_37 = 0; i_37 < 8; ++i_37) {
        ...
        tl::ptx_ldmatrix_x4_trans((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((condval_11 + 31) & 63) >> 5) * 4096) + ((i_37 >> 2) * 2048)) + (ki_3 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_37 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_37 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) + 16384)])) + 0, B_local_1 + (i_37 * 8));
      }
  ...
  if (1 <= condval_12) {
    ...
    for (int ki_4 = 0; ki_4 < 8; ++ki_4) {
      ...
      for (int i_39 = 0; i_39 < 2; ++i_39) {
        ...
        tl::ptx_ldmatrix_x4((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((((((condval_13 + 31) >> 5) + 1) & 1) * 4096) + ((ki_4 >> 2) * 2048)) + (i_39 * 1024)) + (((((int)threadIdx.x) & 31) >> 4) * 512)) + ((((int)threadIdx.x) & 7) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + ((ki_4 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_4 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)])) + 0, B_local + (i_39 * 8));
      }
    ...
    for (int i_40 = 0; i_40 < 16; ++i_40) {
      ...
      float condval_14;
      if ((((((((condval_15 + 31) >> 5) * 32) + ((i_40 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_40 & 1)) < (condval_16 + 32))) {
    ...
    for (int ki_5 = 0; ki_5 < 2; ++ki_5) {
      for (int i_51 = 0; i_51 < 8; ++i_51) {
        ...
        tl::ptx_ldmatrix_x4_trans((&(((bfloat16_t*)buf_dyn_shmem)[((((((((((condval_17 + 31) >> 5) + 1) & 1) * 4096) + ((i_51 >> 2) * 2048)) + (ki_5 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_51 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_51 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) + 16384)])) + 0, B_local_1 + (i_51 * 8));
      }
...
// block_dim=(128, 1, 1).
// latency: 0.01611 ms vs [ref-0.0177 sim-0.99998], idx: 7