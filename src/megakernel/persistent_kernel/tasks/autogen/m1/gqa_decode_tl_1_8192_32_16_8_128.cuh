...
__device__ __forceinline__ void flashattn_kernel_1_8192_32_16_8_128(const int bx, const int by, const int bz,
  ...
  if (0 < valid_kv_seqlen) {
    ...
    for (int i_5 = 0; i_5 < 4; ++i_5) {
      tl::cp_async_gs<16>(buf_dyn_shmem+(((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i_5 * 1024)) + ((((int)threadIdx.x) >> 4) * 128)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 16)) + 24576), V+((((i_5 * 8192) + ((((int)threadIdx.x) >> 4) * 1024)) + (((int)by) * 128)) + ((((int)threadIdx.x) & 15) * 8)));
    }
    tl::cp_async_commit();
  }
  ...
  if (1 <= valid_kv_seqlen) {
    ...
    for (int i_24 = 0; i_24 < 16; ++i_24) {
      float condval_2;
      if ((((((((valid_kv_seqlen + 31) >> 5) * 32) + ((i_24 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_24 & 1)) < (valid_kv_seqlen + 32))) {
  ...
  for (int i_38 = 0; i_38 < 32; ++i_38) {
    if ((((((((int)threadIdx.x) >> 5) * 8) + ((i_38 & 1) * 4)) + ((((int)threadIdx.x) & 31) >> 3)) < 1) && (((((((int)threadIdx.x) >> 5) * 8) + ((i_38 & 1) * 4)) + ((((int)threadIdx.x) & 31) >> 3)) < 1)) {
      uint1 __3;
      float2 v__2 = *(float2*)(acc_o + (i_38 * 2));
      *reinterpret_cast<__nv_bfloat162*>(&(__3)) = __float22bfloat162_rn(*(float2*)(&(v__2)));
      *(uint1*)(((bfloat16_t*)buf_dyn_shmem) + ((((((((int)threadIdx.x) >> 5) * 2048) + ((i_38 & 1) * 1024)) + (((((int)threadIdx.x) & 31) >> 2) * 128)) + ((i_38 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = __3;
    }
  }
  __syncthreads();
...
// block_dim=(128, 1, 1).
// latency: 0.00909 ms vs [ref-0.00948 sim-1.0], idx: 3