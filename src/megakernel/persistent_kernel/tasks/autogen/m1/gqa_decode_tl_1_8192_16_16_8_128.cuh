...
__device__ __forceinline__ void flashattn_kernel_1_8192_16_16_8_128(const int bx, const int by, const int bz,
  ...
  for (int i_36 = 0; i_36 < 32; ++i_36) {
    if ((((((((int)threadIdx.x) >> 5) * 8) + ((i_36 & 1) * 4)) + ((((int)threadIdx.x) & 31) >> 3)) < 1) && (((((((int)threadIdx.x) >> 5) * 8) + ((i_36 & 1) * 4)) + ((((int)threadIdx.x) & 31) >> 3)) < 1)) {
      uint1 __3;
...
// block_dim=(128, 1, 1).
// latency: 0.00878 ms vs [ref-0.00929 sim-1.0], idx: -1