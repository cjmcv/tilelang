...
__device__ __forceinline__ void flashattn_kernel_1_8192_16_16_8_128(const int bx, const int by, const int bz,
  ...
  if (0 < valid_kv_seqlen) {
    ...
    for (int i_5 = 0; i_5 < 8; ++i_5) {
      tl::cp_async_gs<16>(buf_dyn_shmem+(((((((((((int)threadIdx.x) & 15) >> 3) * 8192) + (i_5 * 1024)) + ((((int)threadIdx.x) >> 4) * 128)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 16)) + 49152), V+((((i_5 * 8192) + ((((int)threadIdx.x) >> 4) * 1024)) + (((int)by) * 128)) + ((((int)threadIdx.x) & 15) * 8)));
    }
    tl::cp_async_commit();
  }
  if (64 < valid_kv_seqlen) {
    ...
    for (int i_6 = 0; i_6 < 8; ++i_6) {
      tl::cp_async_gs<16>(buf_dyn_shmem+(((((((((((int)threadIdx.x) & 15) >> 3) * 8192) + (i_6 * 1024)) + ((((int)threadIdx.x) >> 4) * 128)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 16)) + 32768), K+(((((i_6 * 8192) + ((((int)threadIdx.x) >> 4) * 1024)) + (((int)by) * 128)) + ((((int)threadIdx.x) & 15) * 8)) + 65536));
    }
    tl::cp_async_commit();
    #pragma unroll
    for (int i_7 = 0; i_7 < 8; ++i_7) {
      tl::cp_async_gs<16>(buf_dyn_shmem+(((((((((((int)threadIdx.x) & 15) >> 3) * 8192) + (i_7 * 1024)) + ((((int)threadIdx.x) >> 4) * 128)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 16)) + 65536), V+(((((i_7 * 8192) + ((((int)threadIdx.x) >> 4) * 1024)) + (((int)by) * 128)) + ((((int)threadIdx.x) & 15) * 8)) + 65536));
    }
    tl::cp_async_commit();
  }
  for (int k = 0; k < (((valid_kv_seqlen + 63) >> 6) - 2); ++k) {
    ...
    for (int i_11 = 0; i_11 < 32; ++i_11) {
      float condval_1;
      if ((((((k * 64) + ((i_11 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_11 & 1)) < valid_kv_seqlen)) {
  ...
  if (65 <= valid_kv_seqlen) {
    ...
    for (int ki_2 = 0; ki_2 < 8; ++ki_2) {
      ...
      for (int i_25 = 0; i_25 < 4; ++i_25) {
        tl::ptx_ldmatrix_x4((&(((bfloat16_t*)buf_dyn_shmem)[((((((((((((valid_kv_seqlen + 63) & 127) >> 6) * 8192) + ((ki_2 >> 2) * 4096)) + (i_25 * 1024)) + (((((int)threadIdx.x) & 31) >> 4) * 512)) + ((((int)threadIdx.x) & 7) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + ((ki_2 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_2 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)])) + 0, B_local + (i_25 * 8));
      }
    ...
    for (int i_26 = 0; i_26 < 32; ++i_26) {
      float condval_2;
      if ((((((((valid_kv_seqlen + 63) >> 6) * 64) + ((i_26 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_26 & 1)) < (valid_kv_seqlen + 128))) {
    ...
    for (int ki_3 = 0; ki_3 < 4; ++ki_3) {
      for (int i_37 = 0; i_37 < 8; ++i_37) {
        tl::ptx_ldmatrix_x4_trans((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((valid_kv_seqlen + 63) & 127) >> 6) * 8192) + ((i_37 >> 2) * 4096)) + (ki_3 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_37 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_37 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) + 24576)])) + 0, B_local_1 + (i_37 * 8));
      }
  ...
  if (1 <= valid_kv_seqlen) {
    ...
    for (int ki_4 = 0; ki_4 < 8; ++ki_4) {
      ...
      for (int i_39 = 0; i_39 < 4; ++i_39) {
        tl::ptx_ldmatrix_x4((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((((((valid_kv_seqlen + 63) >> 6) + 1) & 1) * 8192) + ((ki_4 >> 2) * 4096)) + (i_39 * 1024)) + (((((int)threadIdx.x) & 31) >> 4) * 512)) + ((((int)threadIdx.x) & 7) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + ((ki_4 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_4 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)])) + 0, B_local + (i_39 * 8));
      }
    ...
    for (int i_40 = 0; i_40 < 32; ++i_40) {
      float condval_3;
      if ((((((((valid_kv_seqlen + 63) >> 6) * 64) + ((i_40 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_40 & 1)) < (valid_kv_seqlen + 64))) {
    ...
    for (int ki_5 = 0; ki_5 < 4; ++ki_5) {
      for (int i_51 = 0; i_51 < 8; ++i_51) {
        tl::ptx_ldmatrix_x4_trans((&(((bfloat16_t*)buf_dyn_shmem)[((((((((((valid_kv_seqlen + 63) >> 6) + 1) & 1) * 8192) + ((i_51 >> 2) * 4096)) + (ki_5 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_51 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_51 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) + 24576)])) + 0, B_local_1 + (i_51 * 8));
      }
  ...
  for (int i_54 = 0; i_54 < 32; ++i_54) {
    if ((((((((int)threadIdx.x) >> 5) * 8) + ((i_54 & 1) * 4)) + ((((int)threadIdx.x) & 31) >> 3)) < 1) && (((((((int)threadIdx.x) >> 5) * 8) + ((i_54 & 1) * 4)) + ((((int)threadIdx.x) & 31) >> 3)) < 1)) {
      uint1 __4;
      float2 v__3 = *(float2*)(acc_o + (i_54 * 2));
      *reinterpret_cast<__nv_bfloat162*>(&(__4)) = __float22bfloat162_rn(*(float2*)(&(v__3)));
      *(uint1*)(((bfloat16_t*)buf_dyn_shmem) + ((((((((int)threadIdx.x) >> 5) * 2048) + ((i_54 & 1) * 1024)) + (((((int)threadIdx.x) & 31) >> 2) * 128)) + ((i_54 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = __4;
    }
  }
  __syncthreads();
