...
__device__ __forceinline__ void flashattn_kernel_1_8192_2048_16_8_128__0(const int bx, const int by, const int bz,
  ...
  if (0 < condval_1) {
    ...
    for (int i_4 = 0; i_4 < 8; ++i_4) {
      tl::cp_async_gs_conditional<16>(buf_dyn_shmem+(((((((((((int)threadIdx.x) & 15) >> 3) * 8192) + (i_4 * 1024)) + ((((int)threadIdx.x) >> 4) * 128)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 16)) + 16384), K+(((((((int64_t)i_4) * (int64_t)8192) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)4) * (int64_t)1024)) + ((((int64_t)((int)bz)) * (((int64_t)actual_kv_seqlen) >> (int64_t)1)) * (int64_t)1024)) + (((int64_t)((int)by)) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)8)), (((((((i_4 * 8) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 1))) < 8192) && (0 <= (((i_4 * 8) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 1))))) && (0 <= (((i_4 * 8) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 1))))) && ((((i_4 * 8) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 1))) < 8192)));
    }
    tl::cp_async_commit();
    #pragma unroll
    for (int i_5 = 0; i_5 < 8; ++i_5) {
      tl::cp_async_gs_conditional<16>(buf_dyn_shmem+(((((((((((int)threadIdx.x) & 15) >> 3) * 8192) + (i_5 * 1024)) + ((((int)threadIdx.x) >> 4) * 128)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 16)) + 49152), V+(((((((int64_t)i_5) * (int64_t)8192) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)4) * (int64_t)1024)) + ((((int64_t)((int)bz)) * (((int64_t)actual_kv_seqlen) >> (int64_t)1)) * (int64_t)1024)) + (((int64_t)((int)by)) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)8)), (((((((i_5 * 8) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 1))) < 8192) && (0 <= (((i_5 * 8) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 1))))) && (0 <= (((i_5 * 8) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 1))))) && ((((i_5 * 8) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 1))) < 8192)));
    }
    tl::cp_async_commit();
  }
  int condval_2;
  ...
  if (64 < condval_2) {
    ...
    for (int i_6 = 0; i_6 < 8; ++i_6) {
      tl::cp_async_gs_conditional<16>(buf_dyn_shmem+(((((((((((int)threadIdx.x) & 15) >> 3) * 8192) + (i_6 * 1024)) + ((((int)threadIdx.x) >> 4) * 128)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 16)) + 32768), K+((((((((int64_t)i_6) * (int64_t)8192) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)4) * (int64_t)1024)) + ((((int64_t)((int)bz)) * (((int64_t)actual_kv_seqlen) >> (int64_t)1)) * (int64_t)1024)) + (((int64_t)((int)by)) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)8)) + (int64_t)65536), (((((((i_6 * 8) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 1))) < 8128) && (-64 <= (((i_6 * 8) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 1))))) && (-64 <= (((i_6 * 8) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 1))))) && ((((i_6 * 8) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 1))) < 8128)));
    }
    tl::cp_async_commit();
    #pragma unroll
    for (int i_7 = 0; i_7 < 8; ++i_7) {
      tl::cp_async_gs_conditional<16>(buf_dyn_shmem+(((((((((((int)threadIdx.x) & 15) >> 3) * 8192) + (i_7 * 1024)) + ((((int)threadIdx.x) >> 4) * 128)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 16)) + 65536), V+((((((((int64_t)i_7) * (int64_t)8192) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)4) * (int64_t)1024)) + ((((int64_t)((int)bz)) * (((int64_t)actual_kv_seqlen) >> (int64_t)1)) * (int64_t)1024)) + (((int64_t)((int)by)) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)8)) + (int64_t)65536), (((((((i_7 * 8) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 1))) < 8128) && (-64 <= (((i_7 * 8) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 1))))) && (-64 <= (((i_7 * 8) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 1))))) && ((((i_7 * 8) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 1))) < 8128)));
    }
    tl::cp_async_commit();
  }
  int condval_3;
  ...
  for (int k = 0; k < (((condval_3 + 63) >> 6) - 2); ++k) {
    ...
    for (int ki = 0; ki < 8; ++ki) {
      ...
      for (int i_9 = 0; i_9 < 4; ++i_9) {
        tl::ptx_ldmatrix_x4((&(((bfloat16_t*)buf_dyn_shmem)[((((((((((k & 1) * 8192) + ((ki >> 2) * 4096)) + (i_9 * 1024)) + (((((int)threadIdx.x) & 31) >> 4) * 512)) + ((((int)threadIdx.x) & 7) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + ((ki & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)])) + 0, B_local + (i_9 * 8));
      }
      for (int j = 0; j < 4; ++j) {
    ...
    for (int i_10 = 0; i_10 < 8; ++i_10) {
      tl::cp_async_gs_conditional<16>(buf_dyn_shmem+(((((((((k & 1) * 16384) + (((((int)threadIdx.x) & 15) >> 3) * 8192)) + (i_10 * 1024)) + ((((int)threadIdx.x) >> 4) * 128)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 16)) + 16384), K+(((((((((int64_t)k) * (int64_t)65536) + (((int64_t)i_10) * (int64_t)8192)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)4) * (int64_t)1024)) + ((((int64_t)((int)bz)) * (((int64_t)actual_kv_seqlen) >> (int64_t)1)) * (int64_t)1024)) + (((int64_t)((int)by)) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)8)) + (int64_t)131072), ((((((((k * 64) + (i_10 * 8)) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 1))) < 8064) && (-128 <= ((((k * 64) + (i_10 * 8)) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 1))))) && (-128 <= ((((k * 64) + (i_10 * 8)) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 1))))) && (((((k * 64) + (i_10 * 8)) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 1))) < 8064)));
    }
    tl::cp_async_commit();
    #pragma unroll
    for (int i_11 = 0; i_11 < 32; ++i_11) {
      ...
      float condval_4;
      if ((((((k * 64) + ((i_11 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_11 & 1)) < condval_5)) {
        condval_4 = acc_s[i_11];
      } else {
        condval_4 = -CUDART_INF_F;
      }
      acc_s[i_11] = condval_4;
    }
    #pragma unroll
    ...
    for (int i_14 = 0; i_14 < 2; ++i_14) {
      ...
      for (int rv = 0; rv < 16; ++rv) {
        scores_max[i_14] = max(scores_max[i_14], acc_s[((((rv & 7) * 4) + (i_14 * 2)) + (rv >> 3))]);
      }
    ...
    for (int i_18 = 0; i_18 < 2; ++i_18) {
      ...
      for (int rv_1 = 0; rv_1 < 16; ++rv_1) {
        scores_sum[i_18] = (scores_sum[i_18] + acc_s[((((rv_1 & 7) * 4) + (i_18 * 2)) + (rv_1 >> 3))]);
      }
    ...
    for (int ki_1 = 0; ki_1 < 4; ++ki_1) {
      for (int i_22 = 0; i_22 < 8; ++i_22) {
        tl::ptx_ldmatrix_x4_trans((&(((bfloat16_t*)buf_dyn_shmem)[(((((((k & 1) * 8192) + ((i_22 >> 2) * 4096)) + (ki_1 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_22 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_22 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) + 24576)])) + 0, B_local_1 + (i_22 * 8));
      }
    ...
    for (int i_23 = 0; i_23 < 8; ++i_23) {
      tl::cp_async_gs_conditional<16>(buf_dyn_shmem+(((((((((k & 1) * 16384) + (((((int)threadIdx.x) & 15) >> 3) * 8192)) + (i_23 * 1024)) + ((((int)threadIdx.x) >> 4) * 128)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 16)) + 49152), V+(((((((((int64_t)k) * (int64_t)65536) + (((int64_t)i_23) * (int64_t)8192)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)4) * (int64_t)1024)) + ((((int64_t)((int)bz)) * (((int64_t)actual_kv_seqlen) >> (int64_t)1)) * (int64_t)1024)) + (((int64_t)((int)by)) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)8)) + (int64_t)131072), ((((((((k * 64) + (i_23 * 8)) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 1))) < 8064) && (-128 <= ((((k * 64) + (i_23 * 8)) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 1))))) && (-128 <= ((((k * 64) + (i_23 * 8)) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 1))))) && (((((k * 64) + (i_23 * 8)) + (((int)threadIdx.x) >> 4)) + (((int)bz) * (actual_kv_seqlen >> 1))) < 8064)));
    }
    tl::cp_async_commit();
  }
  int condval_6;
  ...
  if (65 <= condval_6) {
    ...
    for (int ki_2 = 0; ki_2 < 8; ++ki_2) {
      ...
      for (int i_25 = 0; i_25 < 4; ++i_25) {
        ...
        tl::ptx_ldmatrix_x4((&(((bfloat16_t*)buf_dyn_shmem)[((((((((((((condval_7 + 63) & 127) >> 6) * 8192) + ((ki_2 >> 2) * 4096)) + (i_25 * 1024)) + (((((int)threadIdx.x) & 31) >> 4) * 512)) + ((((int)threadIdx.x) & 7) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + ((ki_2 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_2 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)])) + 0, B_local + (i_25 * 8));
      }
    ...
    for (int i_26 = 0; i_26 < 32; ++i_26) {
      ...
      float condval_8;
      if ((((((((condval_9 + 63) >> 6) * 64) + ((i_26 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_26 & 1)) < (condval_10 + 128))) {
        condval_8 = acc_s[i_26];
      } else {
        condval_8 = -CUDART_INF_F;
      }
      acc_s[i_26] = condval_8;
    }
    #pragma unroll
    ...
    for (int ki_3 = 0; ki_3 < 4; ++ki_3) {
      for (int i_37 = 0; i_37 < 8; ++i_37) {
        ...
        tl::ptx_ldmatrix_x4_trans((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((condval_11 + 63) & 127) >> 6) * 8192) + ((i_37 >> 2) * 4096)) + (ki_3 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_37 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_37 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) + 24576)])) + 0, B_local_1 + (i_37 * 8));
      }
  ...
  if (1 <= condval_12) {
    ...
    for (int ki_4 = 0; ki_4 < 8; ++ki_4) {
      ...
      for (int i_39 = 0; i_39 < 4; ++i_39) {
        ...
        tl::ptx_ldmatrix_x4((&(((bfloat16_t*)buf_dyn_shmem)[(((((((((((((condval_13 + 63) >> 6) + 1) & 1) * 8192) + ((ki_4 >> 2) * 4096)) + (i_39 * 1024)) + (((((int)threadIdx.x) & 31) >> 4) * 512)) + ((((int)threadIdx.x) & 7) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + ((ki_4 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_4 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)])) + 0, B_local + (i_39 * 8));
      }
    ...
    for (int i_40 = 0; i_40 < 32; ++i_40) {
      ...
      float condval_14;
      if ((((((((condval_15 + 63) >> 6) * 64) + ((i_40 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_40 & 1)) < (condval_16 + 64))) {
        condval_14 = acc_s[i_40];
      } else {
        condval_14 = -CUDART_INF_F;
      }
      acc_s[i_40] = condval_14;
    }
    #pragma unroll
    ...
    for (int i_43 = 0; i_43 < 2; ++i_43) {
      ...
      for (int rv_4 = 0; rv_4 < 16; ++rv_4) {
        scores_max[i_43] = max(scores_max[i_43], acc_s[((((rv_4 & 7) * 4) + (i_43 * 2)) + (rv_4 >> 3))]);
      }
    ...
    for (int i_47 = 0; i_47 < 2; ++i_47) {
      ...
      for (int rv_5 = 0; rv_5 < 16; ++rv_5) {
        scores_sum[i_47] = (scores_sum[i_47] + acc_s[((((rv_5 & 7) * 4) + (i_47 * 2)) + (rv_5 >> 3))]);
      }
    ...
    for (int ki_5 = 0; ki_5 < 4; ++ki_5) {
      for (int i_51 = 0; i_51 < 8; ++i_51) {
        ...
        tl::ptx_ldmatrix_x4_trans((&(((bfloat16_t*)buf_dyn_shmem)[((((((((((condval_17 + 63) >> 6) + 1) & 1) * 8192) + ((i_51 >> 2) * 4096)) + (ki_5 * 1024)) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_51 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_51 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) + 24576)])) + 0, B_local_1 + (i_51 * 8));
      }
  ...
  if ((((int)threadIdx.x) % 4) == 0) {
    ...
    for (int i_54 = 0; i_54 < 2; ++i_54) {
      if (((((((int)threadIdx.x) >> 5) * 8) + (i_54 * 4)) + ((((int)threadIdx.x) & 31) >> 3)) < 1) {
        glse[((((((((int)threadIdx.x) >> 5) * 32) + (i_54 * 16)) + (((int)by) * 4)) + (((((int)threadIdx.x) & 31) >> 2) * 2)) + ((int)bz))] = ((bfloat16_t)logsum[i_54]);
      }
    }
  }
  __syncthreads();
  #pragma unroll
  for (int i_55 = 0; i_55 < 32; ++i_55) {
    if ((((((((int)threadIdx.x) >> 5) * 8) + ((i_55 & 1) * 4)) + ((((int)threadIdx.x) & 31) >> 3)) < 1) && (((((((int)threadIdx.x) >> 5) * 8) + ((i_55 & 1) * 4)) + ((((int)threadIdx.x) & 31) >> 3)) < 1)) {
      uint1 __4;
      float2 v__3 = *(float2*)(acc_o + (i_55 * 2));
      *reinterpret_cast<__nv_bfloat162*>(&(__4)) = __float22bfloat162_rn(*(float2*)(&(v__3)));
      *(uint1*)(((bfloat16_t*)buf_dyn_shmem) + ((((((((int)threadIdx.x) >> 5) * 2048) + ((i_55 & 1) * 1024)) + (((((int)threadIdx.x) & 31) >> 2) * 128)) + ((i_55 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = __4;
    }
  }
  __syncthreads();
