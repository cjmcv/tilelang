...
__device__ __forceinline__ void flashattn_kernel_1_8192_2048_16_8_128__0(const int bx, const int by, const int bz,
  ...
  if ((((int)threadIdx.x) % 4) == 0) {
    ...
    for (int i_70 = 0; i_70 < 2; ++i_70) {
      if (((((((int)threadIdx.x) >> 5) * 8) + (i_70 * 4)) + ((((int)threadIdx.x) & 31) >> 3)) < 1) {
        glse[((((((((int)threadIdx.x) >> 5) * 32) + (i_70 * 16)) + (((int)by) * 4)) + (((((int)threadIdx.x) & 31) >> 2) * 2)) + ((int)bz))] = ((bfloat16_t)logsum[i_70]);
      }
    }
  }
  __syncthreads();
  ...
  for (int i_71 = 0; i_71 < 32; ++i_71) {
    if ((((((((int)threadIdx.x) >> 5) * 8) + ((i_71 & 1) * 4)) + ((((int)threadIdx.x) & 31) >> 3)) < 1) && (((((((int)threadIdx.x) >> 5) * 8) + ((i_71 & 1) * 4)) + ((((int)threadIdx.x) & 31) >> 3)) < 1)) {
      uint1 __5;
      float2 v__4 = *(float2*)(acc_o + (i_71 * 2));
      *reinterpret_cast<__nv_bfloat162*>(&(__5)) = __float22bfloat162_rn(*(float2*)(&(v__4)));
      *(uint1*)(((bfloat16_t*)buf_dyn_shmem) + ((((((((int)threadIdx.x) >> 5) * 2048) + ((i_71 & 1) * 1024)) + (((((int)threadIdx.x) & 31) >> 2) * 128)) + ((i_71 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = __5;
    }
  }
  __syncthreads();
...
// block_dim=(128, 1, 1).
// latency: 0.06976 ms vs [ref-0.07094 sim-0.99996], idx: 8