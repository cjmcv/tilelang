...
__device__ __forceinline__ void flashattn_kernel_1_8192_16_8_128__0(const int bx, const int by, const int bz,
  ...
  for (int i_4 = 0; i_4 < 8; ++i_4) {
    tl::cp_async_gs<16>(buf_dyn_shmem+(((((((((((int)threadIdx.x) & 15) >> 3) * 8192) + (i_4 * 1024)) + ((((int)threadIdx.x) >> 4) * 128)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 16)) + 16384), K+(((((((int)bz) * 1048576) + (i_4 * 8192)) + ((((int)threadIdx.x) >> 4) * 1024)) + (((int)by) * 128)) + ((((int)threadIdx.x) & 15) * 8)));
  }
  tl::cp_async_commit();
  #pragma unroll
  for (int i_5 = 0; i_5 < 8; ++i_5) {
    tl::cp_async_gs<16>(buf_dyn_shmem+(((((((((((int)threadIdx.x) & 15) >> 3) * 8192) + (i_5 * 1024)) + ((((int)threadIdx.x) >> 4) * 128)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 16)) + 32768), V+(((((((int)bz) * 1048576) + (i_5 * 8192)) + ((((int)threadIdx.x) >> 4) * 1024)) + (((int)by) * 128)) + ((((int)threadIdx.x) & 15) * 8)));
  }
  tl::cp_async_commit();
  for (int k = 0; k < 15; ++k) {
    #pragma unroll
    for (int i_6 = 0; i_6 < 16; ++i_6) {
      mask_local[i_6] = mask[((((((((int)bz) * 8192) + (k * 512)) + ((i_6 >> 1) * 64)) + ((((int)threadIdx.x) & 3) * 16)) + ((i_6 & 1) * 8)) + ((int)by))];
    }
    #pragma unroll
    ...
    for (int i_9 = 0; i_9 < 8; ++i_9) {
      tl::cp_async_gs<16>(buf_dyn_shmem+(((((((((((int)threadIdx.x) & 15) >> 3) * 8192) + (i_9 * 1024)) + ((((int)threadIdx.x) >> 4) * 128)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 16)) + 16384), K+(((((((((int)bz) * 1048576) + (k * 65536)) + (i_9 * 8192)) + ((((int)threadIdx.x) >> 4) * 1024)) + (((int)by) * 128)) + ((((int)threadIdx.x) & 15) * 8)) + 65536));
    }
    tl::cp_async_commit();
    #pragma unroll
    for (int i_10 = 0; i_10 < 32; ++i_10) {
      float condval_1;
      if (((0 < ((int)mask_local[(((i_10 >> 2) * 2) + (i_10 & 1))])) & (bool)1)) {
    ...
    for (int i_22 = 0; i_22 < 8; ++i_22) {
      tl::cp_async_gs<16>(buf_dyn_shmem+(((((((((((int)threadIdx.x) & 15) >> 3) * 8192) + (i_22 * 1024)) + ((((int)threadIdx.x) >> 4) * 128)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 16)) + 32768), V+(((((((((int)bz) * 1048576) + (k * 65536)) + (i_22 * 8192)) + ((((int)threadIdx.x) >> 4) * 1024)) + (((int)by) * 128)) + ((((int)threadIdx.x) & 15) * 8)) + 65536));
    }
    tl::cp_async_commit();
  }
  #pragma unroll
  for (int i_23 = 0; i_23 < 16; ++i_23) {
    mask_local[i_23] = mask[((((((((int)bz) * 8192) + ((i_23 >> 1) * 64)) + ((((int)threadIdx.x) & 3) * 16)) + ((i_23 & 1) * 8)) + ((int)by)) + 7680)];
  }
  #pragma unroll
  ...
  for (int i_26 = 0; i_26 < 32; ++i_26) {
    float condval_2;
    if (((0 < ((int)mask_local[(((i_26 >> 2) * 2) + (i_26 & 1))])) & (bool)1)) {
  ...
  if ((((int)threadIdx.x) % 4) == 0) {
    ...
    for (int i_40 = 0; i_40 < 2; ++i_40) {
      if (((((((int)threadIdx.x) >> 5) * 8) + (i_40 * 4)) + ((((int)threadIdx.x) & 31) >> 3)) < 1) {
        glse[((((((((int)threadIdx.x) >> 5) * 128) + (i_40 * 64)) + (((int)by) * 16)) + (((((int)threadIdx.x) & 31) >> 2) * 8)) + ((int)bz))] = ((bfloat16_t)logsum[i_40]);
      }
    }
  }
  __syncthreads();
  ...
  for (int i_41 = 0; i_41 < 32; ++i_41) {
    if ((((((((int)threadIdx.x) >> 5) * 8) + ((i_41 & 1) * 4)) + ((((int)threadIdx.x) & 31) >> 3)) < 1) && (((((((int)threadIdx.x) >> 5) * 8) + ((i_41 & 1) * 4)) + ((((int)threadIdx.x) & 31) >> 3)) < 1)) {
      uint1 __3;
      float2 v__2 = *(float2*)(acc_o + (i_41 * 2));
      *reinterpret_cast<__nv_bfloat162*>(&(__3)) = __float22bfloat162_rn(*(float2*)(&(v__2)));
      *(uint1*)(((bfloat16_t*)buf_dyn_shmem) + ((((((((int)threadIdx.x) >> 5) * 2048) + ((i_41 & 1) * 1024)) + (((((int)threadIdx.x) & 31) >> 2) * 128)) + ((i_41 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = __3;
    }
  }
  __syncthreads();
