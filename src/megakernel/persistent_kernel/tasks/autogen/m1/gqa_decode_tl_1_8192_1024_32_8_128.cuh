...
template <typename T,
          ...
          int GROUPS,
          int DIM>
__device__ __forceinline__ void flashattn_kernel_1_8192_1024_32_8_128__0(const int bx, const int by, const int bz,
  ...
  if constexpr (SUB_KERNEL_ID == 1) { if (bx >= 32 || by >= 1 || bz >= 1) { return; } }
  ...
  if ((((int)threadIdx.x) % 4) == 0) {
    ...
    for (int i_38 = 0; i_38 < 2; ++i_38) {
      if (((((((int)threadIdx.x) >> 5) * 4) + (i_38 * 2)) + ((((int)threadIdx.x) & 31) >> 4)) < 1) {
        glse[((((((((int)threadIdx.x) >> 5) * 32) + (i_38 * 16)) + (((int)by) * 8)) + (((((int)threadIdx.x) & 31) >> 2) * 2)) + ((int)bz))] = ((bfloat16_t)logsum[i_38]);
      }
    }
  }
  __syncthreads();
  ...
  for (int i_39 = 0; i_39 < 32; ++i_39) {
    if ((((((((int)threadIdx.x) >> 5) * 4) + ((i_39 & 1) * 2)) + ((((int)threadIdx.x) & 31) >> 4)) < 1) && (((((((int)threadIdx.x) >> 5) * 4) + ((i_39 & 1) * 2)) + ((((int)threadIdx.x) & 31) >> 4)) < 1)) {
      uint1 __3;
  ...
  __syncthreads();
  *(uint2*)(Output_partial + ((((((int)by) * 1024) + ((((int)threadIdx.x) >> 5) * 256)) + (((int)bz) * 128)) + ((((int)threadIdx.x) & 31) * 4))) = *(uint2*)(((bfloat16_t*)buf_dyn_shmem) + (((int)threadIdx.x) * 4));
}
...
template <typename T,
          ...
          int GROUPS,
          int DIM>
__device__ __forceinline__ void flashattn_kernel_1_8192_1024_32_8_128__1(const int bx, const int by, const int bz,
                                                   const void* __restrict__ q, 
                                                   const void* __restrict__ k, 
                                                   const void* __restrict__ v,
                                                   const void* __restrict__ edge_ptr, 
...
// Strategy: gqa_decode_tl_1_8192_1024_32_8_128
// selected_hparams: [64, 64, 2, 1, 128].
// smem: 0 bytes.
// use_cooperative_groups: 0.
// layout: (1, 8, 2), (64, 64, 2), (32, 1, 1), (64, 64, 2)
// block_dim=(128, 1, 1).
// latency: 0.06057 ms vs [ref-0.05339 sim-0.99915], idx: -1