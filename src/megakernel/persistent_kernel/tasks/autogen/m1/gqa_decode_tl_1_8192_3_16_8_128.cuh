...
template <typename T,
          ...
          int GROUPS,
          int DIM>
__device__ __forceinline__ void flashattn_kernel_1_8192_3_16_8_128(const int bx, const int by, const int bz,
  ...
  for (int i_4 = 0; i_4 < 3; ++i_4) {
    ((bfloat16_t*)buf_dyn_shmem)[((((((((((int)threadIdx.x) >> 6) * 1024) + (i_4 * 64)) + (((((int)threadIdx.x) & 63) >> 5) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_4 >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (i_4 & 1)) & 1) * 8)) + (((int)threadIdx.x) & 7)) + 8192)] = K[(((i_4 * 1024) + (((int)by) * 128)) + ((int)threadIdx.x))];
  }
  #pragma unroll
  ...
  for (int i_6 = 0; i_6 < 8; ++i_6) {
    float condval_1;
    if ((((((i_6 >> 2) * 8) + ((((int)threadIdx.x) & 3) * 2)) + (i_6 & 1)) < 3)) {
      condval_1 = acc_s[i_6];
    } else {
  ...
  for (int i_17 = 0; i_17 < 3; ++i_17) {
    ((bfloat16_t*)buf_dyn_shmem)[(((((((((int)threadIdx.x) >> 6) * 1024) + (i_17 * 64)) + (((((int)threadIdx.x) & 63) >> 5) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (i_17 >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (i_17 & 1)) & 1) * 8)) + (((int)threadIdx.x) & 7))] = V[(((i_17 * 1024) + (((int)by) * 128)) + ((int)threadIdx.x))];
  }
  __syncthreads();
...
// Strategy: gqa_decode_tl_1_8192_3_16_8_128
// selected_hparams: [16, 64, 1, 1, 128].
// smem: 20480 bytes.
// use_cooperative_groups: 0.
// layout: (1, 8, 1), (16, 64, 1)
// block_dim=(128, 1, 1).
// latency: 0.00789 ms vs [ref-0.00769 sim-1.0], idx: -1