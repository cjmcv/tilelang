...
template <typename T,
          ...
          int GROUPS,
          int DIM>
__device__ __forceinline__ void flashattn_kernel_1_8192_10_16_8_128(const int bx, const int by, const int bz,
  ...
  for (int i_4 = 0; i_4 < 5; ++i_4) {
    *(uint1*)(((bfloat16_t*)buf_dyn_shmem) + ((((((((((((int)threadIdx.x) & 63) >> 5) * 1024) + (i_4 * 128)) + ((((int)threadIdx.x) >> 6) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_4 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + (i_4 & 1)) & 1) * 16)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 8192)) = *(uint1*)(K + ((((i_4 * 2048) + ((((int)threadIdx.x) >> 6) * 1024)) + (((int)by) * 128)) + ((((int)threadIdx.x) & 63) * 2)));
  }
  #pragma unroll
  ...
  for (int i_6 = 0; i_6 < 8; ++i_6) {
    float condval_1;
    if (((((i_6 >> 2) * 4) + (((int)threadIdx.x) & 3)) < 5)) {
      condval_1 = acc_s[i_6];
    } else {
  ...
  __syncthreads();
  #pragma unroll
  for (int i_17 = 0; i_17 < 5; ++i_17) {
    *(uint1*)(((bfloat16_t*)buf_dyn_shmem) + (((((((((((int)threadIdx.x) & 63) >> 5) * 1024) + (i_17 * 128)) + ((((int)threadIdx.x) >> 6) * 64)) + (((((((int)threadIdx.x) & 31) >> 4) + ((i_17 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 15) >> 3) + (i_17 & 1)) & 1) * 16)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = *(uint1*)(V + ((((i_17 * 2048) + ((((int)threadIdx.x) >> 6) * 1024)) + (((int)by) * 128)) + ((((int)threadIdx.x) & 63) * 2)));
  }
  __syncthreads();
...
// Strategy: gqa_decode_tl_1_8192_10_16_8_128
// selected_hparams: [16, 64, 1, 1, 128].
// smem: 20480 bytes.
// use_cooperative_groups: 0.
// layout: (1, 8, 1), (16, 64, 1)
// block_dim=(128, 1, 1).
// latency: 0.0086 ms vs [ref-0.00907 sim-1.0], idx: -1