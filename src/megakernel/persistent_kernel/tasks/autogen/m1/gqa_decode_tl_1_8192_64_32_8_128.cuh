...
template <typename T,
          ...
          int GROUPS,
          int DIM>
__device__ __forceinline__ void flashattn_kernel_1_8192_64_32_8_128(const int bx, const int by, const int bz,
  ...
  static_assert(M==1); static_assert(HEAD==32); static_assert(GROUPS==8); static_assert(DIM==128);
  ...
  for (int i = 0; i < 8; ++i) {
    uint4 condval;
    if (((((((((int)threadIdx.x) >> 6) + ((int)by)) >> 1) + i) < 4) && (((((((int)threadIdx.x) >> 6) + ((int)by)) >> 1) + i) < 4))) {
      condval = *(uint4*)(Q + (((i * 1024) + (((int)by) * 512)) + (((int)threadIdx.x) * 8)));
    } else {
  ...
  if (0 < valid_kv_seqlen) {
    ...
    for (int i_5 = 0; i_5 < 2; ++i_5) {
      tl::cp_async_gs<16>(buf_dyn_shmem+(((((((((((int)threadIdx.x) & 15) >> 3) * 2048) + (i_5 * 1024)) + ((((int)threadIdx.x) >> 4) * 128)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 16)) + 20480), V+((((i_5 * 8192) + ((((int)threadIdx.x) >> 4) * 1024)) + (((int)by) * 128)) + ((((int)threadIdx.x) & 15) * 8)));
    }
    tl::cp_async_commit();
  }
  for (int k = 0; k < (((valid_kv_seqlen + 15) >> 4) - 1); ++k) {
    ...
    for (int i_7 = 0; i_7 < 2; ++i_7) {
      tl::cp_async_gs_conditional<16>(buf_dyn_shmem+(((((((((((int)threadIdx.x) & 15) >> 3) * 2048) + (i_7 * 1024)) + ((((int)threadIdx.x) >> 4) * 128)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 16)) + 16384), K+((((((((int64_t)k) * (int64_t)16384) + (((int64_t)i_7) * (int64_t)8192)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)4) * (int64_t)1024)) + (((int64_t)((int)by)) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)8)) + (int64_t)16384), (k < 511));
    }
    tl::cp_async_commit();
    #pragma unroll
    ...
    for (int i_11 = 0; i_11 < 2; ++i_11) {
      ...
      for (int rv = 0; rv < 4; ++rv) {
        scores_max[i_11] = max(scores_max[i_11], acc_s[((((rv & 1) * 4) + (i_11 * 2)) + (rv >> 1))]);
      }
    ...
    for (int i_19 = 0; i_19 < 8; ++i_19) {
      tl::ptx_ldmatrix_x4_trans((&(((bfloat16_t*)buf_dyn_shmem)[(((((i_19 >> 2) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_19 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_19 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) + 10240)])) + 0, B_local_1 + (i_19 * 8));
    }
    for (int j = 0; j < 8; ++j) {
    ...
    for (int i_20 = 0; i_20 < 2; ++i_20) {
      tl::cp_async_gs_conditional<16>(buf_dyn_shmem+(((((((((((int)threadIdx.x) & 15) >> 3) * 2048) + (i_20 * 1024)) + ((((int)threadIdx.x) >> 4) * 128)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 16)) + 20480), V+((((((((int64_t)k) * (int64_t)16384) + (((int64_t)i_20) * (int64_t)8192)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)4) * (int64_t)1024)) + (((int64_t)((int)by)) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)8)) + (int64_t)16384), (k < 511));
    }
    tl::cp_async_commit();
  }
  if (1 <= valid_kv_seqlen) {
    ...
    for (int i_22 = 0; i_22 < 8; ++i_22) {
      float condval_2;
      if ((((((((valid_kv_seqlen + 15) >> 4) * 16) + ((i_22 >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_22 & 1)) < (valid_kv_seqlen + 16))) {
    ...
    for (int i_25 = 0; i_25 < 2; ++i_25) {
      ...
      for (int rv_2 = 0; rv_2 < 4; ++rv_2) {
        scores_max[i_25] = max(scores_max[i_25], acc_s[((((rv_2 & 1) * 4) + (i_25 * 2)) + (rv_2 >> 1))]);
      }
    ...
    for (int i_29 = 0; i_29 < 2; ++i_29) {
      ...
      for (int rv_3 = 0; rv_3 < 4; ++rv_3) {
        scores_sum[i_29] = (scores_sum[i_29] + acc_s[((((rv_3 & 1) * 4) + (i_29 * 2)) + (rv_3 >> 1))]);
      }
    ...
    for (int i_33 = 0; i_33 < 8; ++i_33) {
      tl::ptx_ldmatrix_x4_trans((&(((bfloat16_t*)buf_dyn_shmem)[(((((i_33 >> 2) * 1024) + (((((int)threadIdx.x) & 15) >> 3) * 512)) + ((((((((int)threadIdx.x) & 15) * 64) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_33 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_33 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) & 511)) + 10240)])) + 0, B_local_1 + (i_33 * 8));
    }
  ...
  for (int i_36 = 0; i_36 < 32; ++i_36) {
    if ((((((((int)threadIdx.x) >> 5) * 4) + ((i_36 & 1) * 2)) + ((((int)threadIdx.x) & 31) >> 4)) < 1) && (((((((int)threadIdx.x) >> 5) * 4) + ((i_36 & 1) * 2)) + ((((int)threadIdx.x) & 31) >> 4)) < 1)) {
      uint1 __3;
      float2 v__2 = *(float2*)(acc_o + (i_36 * 2));
      *reinterpret_cast<__nv_bfloat162*>(&(__3)) = __float22bfloat162_rn(*(float2*)(&(v__2)));
      *(uint1*)(((bfloat16_t*)buf_dyn_shmem) + ((((((((int)threadIdx.x) >> 5) * 2048) + ((i_36 & 1) * 1024)) + (((((int)threadIdx.x) & 31) >> 2) * 128)) + ((i_36 >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2))) = __3;
    }
  }
  __syncthreads();
  *(uint2*)(Output + ((((int)by) * 512) + (((int)threadIdx.x) * 4))) = *(uint2*)(((bfloat16_t*)buf_dyn_shmem) + (((int)threadIdx.x) * 4));
}


} // kernel
// Strategy: gqa_decode_tl_1_8192_64_32_8_128
// selected_hparams: [16, 64, 1, 1, 128].
// smem: 24576 bytes.
// use_cooperative_groups: 0.
// layout: (1, 8, 1), (16, 64, 1)
// block_dim=(128, 1, 1).
// latency: 0.01127 ms vs [ref-0.00783 sim-0.98866], idx: -1