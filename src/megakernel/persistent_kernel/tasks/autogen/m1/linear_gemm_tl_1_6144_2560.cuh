...
template <typename T,
    ...
    int PIPE_MAX = 3,
    bool FUSE_RES = false>
    __device__ __forceinline__ void linear_gemm_tl_1_6144_2560(const int bx, const int by, const int bz,
  ...
  static_assert(M==1); static_assert(N==6144); static_assert(K==2560);
...
// Strategy: linear_gemm_tl_1_6144_2560
// selected_hparams: [16, 64, 64, 1, 3, 128, 0, False].
// smem: 30720 bytes.
// use_cooperative_groups: 0.
// layout: (96, 1, 1), (64, 16, 64)
// block_dim=(128, 1, 1).
// latency: 0.33129 ms vs [ref-0.28903 sim-1.0], idx: -1