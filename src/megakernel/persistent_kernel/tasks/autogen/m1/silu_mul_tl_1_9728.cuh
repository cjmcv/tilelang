...
__device__ __forceinline__ void silu_mul_kernel_1_9728(const int bx, const int by, const int bz,
  ...
  for (int i = 0; i < 2; ++i) {
    ...
    if (((((i * 16) + (((int)threadIdx.x) >> 3)) < 1) && (((i * 16) + (((int)threadIdx.x) >> 3)) < 1))) {
      condval = *(uint4*)(A + ((((i * 311296) + ((((int)threadIdx.x) >> 3) * 19456)) + (((int)bx) * 64)) + ((((int)threadIdx.x) & 7) * 8)));
    } else {
  ...
  for (int i_1 = 0; i_1 < 2; ++i_1) {
    ...
    if (((((i_1 * 16) + (((int)threadIdx.x) >> 3)) < 1) && (((i_1 * 16) + (((int)threadIdx.x) >> 3)) < 1))) {
      condval_1 = *(uint4*)(A + (((((i_1 * 311296) + ((((int)threadIdx.x) >> 3) * 19456)) + (((int)bx) * 64)) + ((((int)threadIdx.x) & 7) * 8)) + 9728));
    } else {
...
// block_dim=(128, 1, 1).
// latency: 0.00879 ms vs [ref-0.0 sim-1.0], idx: -1