...
template <typename T,
          ...
          int GROUPS,
          int DIM>
__device__ __forceinline__ void flashattn_kernel_1_8192_4_16_8_128(const int bx, const int by, const int bz,
  ...
  *(uint2*)(((bfloat16_t*)buf_dyn_shmem) + (((((((((((int)threadIdx.x) & 31) >> 4) * 1024) + ((((int)threadIdx.x) >> 5) * 64)) + (((((int)threadIdx.x) & 15) >> 3) * 32)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 1) * 4)) + 8192)) = *(uint2*)(K + ((((((int)threadIdx.x) >> 5) * 1024) + (((int)by) * 128)) + ((((int)threadIdx.x) & 31) * 4)));
  #pragma unroll
  ...
  for (int i_5 = 0; i_5 < 8; ++i_5) {
    float condval_1;
    if (((((i_5 >> 2) * 2) + ((((int)threadIdx.x) & 3) >> 1)) < 1)) {
      condval_1 = acc_s[i_5];
    } else {
  ...
  __syncthreads();
  *(uint2*)(((bfloat16_t*)buf_dyn_shmem) + ((((((((((int)threadIdx.x) & 31) >> 4) * 1024) + ((((int)threadIdx.x) >> 5) * 64)) + (((((int)threadIdx.x) & 15) >> 3) * 32)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 1) * 4))) = *(uint2*)(V + ((((((int)threadIdx.x) >> 5) * 1024) + (((int)by) * 128)) + ((((int)threadIdx.x) & 31) * 4)));
  __syncthreads();
...
// Strategy: gqa_decode_tl_1_8192_4_16_8_128
// selected_hparams: [16, 64, 1, 1, 128].
// smem: 20480 bytes.
// use_cooperative_groups: 0.
// layout: (1, 8, 1), (16, 64, 1)
// block_dim=(128, 1, 1).
// latency: 0.00714 ms vs [ref-0.00772 sim-1.0], idx: -1