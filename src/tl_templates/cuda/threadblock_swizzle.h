...
template <int panel_width> TL_DEVICE dim3 rasterization2DRow(const unsigned int bx, const unsigned int by, const unsigned int bz) {
  const unsigned int block_idx = bx + by * gridDim.x;
